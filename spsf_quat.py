...
# ---------------- 参数配置 ----------------
INPUT_SHAPE = (1, 96, 96, 3)       # (batch, H, W, C)
REPRESENTATIVE_SAMPLES = 10000      # 校准样本总数
MODEL_H5_PATH = "save/2/best_model.h5"  # 模型路径
TFLITE_OUTPUT_PATH = "save/2/pfld.tflite"  # 输出路径
USE_REAL_DATA = True               # True=用真实验证集, False=用随机数据

# 真实数据集路径和参数（仅当 USE_REAL_DATA=True 时生效）
JSON_DIR = r"D:\Dataset\faceV3\Labelss"
INPUT_SHAPE_NO_BATCH = (96, 96, 3)
BATCH_SIZE = 64
